...
/**
 * @ORM\Entity
 * @ORM\Table(name="matrimoniopadrino",uniqueConstraints={@ORM\UniqueConstraint(name="matrimonio_padrino_idx", columns={"matrimonio_id", "padrino_id"})})
 * @UniqueEntity(fields={"padrino","matrimonio"})
 */
