...
/**
 * @ORM\Entity
 * @ORM\Table(name="confirmacionpadrino",uniqueConstraints={@ORM\UniqueConstraint(name="confirmacion_padrino_idx", columns={"confirmacion_id", "padrino_id"})})
 * @UniqueEntity(fields={"padrino","confirmacion"}) 
 */
