...
use Parroquia\CertificadoBundle\Form\EventListener\AddConyugeFieldSubscriber;


class MatrimonioConyugeType extends AbstractType
{
    /**
    ...
    {        
        $builder->addEventSubscriber(new AddConyugeFieldSubscriber());                
    ...
    {
        return 'parroquia_certificadobundle_matrimonioconyuge';
    }
}
